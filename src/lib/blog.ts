    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: {
          ...
          ja: [
            '多くのブランドが最初に持ち込む発想は、日本向けにはグローバルのポジショニングをもう少し柔らかく、礼儀正しくしたものが要る、というものです。その発想から生まれるのは、感じはいいけれど記憶に残らない、同じ四半期にローンチする他の[海外ブランド](/japan-market-entry)と見分けのつかない仕事です。',
            'もっと絞り込んだ問いのほうが役に立ちます。グローバルのポジショニングは、約束と、その裏づけの組み合わせでできています。約束はたいてい国境を越えます。裏づけはほぼ越えません。',
            '「世界最高の選手が着用している」という訴求で売るパフォーマンスブランドは、信頼性についての約束をしています。本国市場では、その裏づけは受け手が子どもの頃から見てきた選手たちの名前です。日本では、その名簿がほとんど意味を持たない一方、国内の選手ひとりが海外の全リストより重く働くことがあります。約束は変わりません。裏づけを、現地の素材から組み直す必要があります。',
            ...
            '変えてはいけないのは、御社が選ばれる理由そのものです。現地市場に似るまでブランドを寄せていくのはローカライズではなく、消失です。日本の買い手が、自分たちをより理解している既存プレーヤーではなく御社を選ぶ理由を、それは取り去ってしまいます。',
          ],
        },
      },
      {
      ...
      },
      {
        ...
        paragraphs: {
          ...
          ja: [
            '翻訳されたクリエイティブの失敗は、市場の外からは見えにくい形で起こります。技術的には、どこも間違っていないからです。言葉は正確です。ずれているのはトーンであり、オーディエンスが実際に読んでいるのは、そのトーンのほうです。',
            '崩れるのは、次の箇所です。',
            ...
            'キャスティングとロケーション。そのロケーションが[実際に日本で撮影された](/work/new-balance-japan-ohtani-activation)ものか、どこか安い場所で似せたものかを、オーディエンスは即座に見抜きます。業界メディアも同様です。キャンペーンがこの市場とのつながりを主張するなら、映像がそれに見合っている必要があります。',
