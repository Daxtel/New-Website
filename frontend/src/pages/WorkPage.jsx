          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {filteredProjects.map((project, index) => (
              <Link
                ...
                className="group relative bg-[#302f2c] overflow-hidden transition-all duration-300 hover:bg-[#3f4816]/30"
              >
                {/* Image Placeholder */}
                <div className="aspect-video bg-[#3f4816]/20 relative overflow-hidden">
                  <div className="absolute inset-0 flex items-center justify-center">
                    <span className="text-[#d9fb06]/10 text-8xl font-black">
                ...
                <div className="p-6 md:p-8">
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      <h3 className="mt-2 text-[#d9fb06] font-semibold text-xl md:text-2xl">
                        {t(project.title)}
                      </h3>
                      <p className="mt-3 text-[#888680] text-sm leading-relaxed">
                        {t(project.description)}
                      </p>
                    </div>
                    <div className="flex-shrink-0 w-10 h-10 rounded-full bg-[#3f4816]/30 flex items-center justify-center group-hover:bg-[#d9fb06] transition-colors">
